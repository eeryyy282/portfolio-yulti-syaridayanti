...
*   **No Dead/Unused Code:** Setiap kali melakukan refactoring, pembaruan fitur, atau perubahan logika, seluruh baris kode, fungsi, variabel, ataupun import yang sudah tidak lagi digunakan (unused code) wajib dihapus sepenuhnya. Hal ini krusial untuk mencegah penumpukan "kode sampah" (code bloat) dan memastikan codebase selalu dalam keadaan bersih, ringan, serta terhindar dari fenomena sisa-sisa generasi AI.
